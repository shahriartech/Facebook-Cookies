            ...
            fr.onload = function (evt) {
                try {
                    ...
                    if (Array.isArray(j)) {
                        ...
                        toastNotification("Cookies imported successfully!");
                    } else {
                        toastNotification("Invalid Cookies File (not a Cookies JSON file).");
                    }
                } catch (_) {
                    toastNotification("Failed to load Cookies File (Malformed?)");
                }
            }
        }
    }
    ...
    function exportFunc(encrypted) {
        chrome.cookies.getAll({
            ...
            btnCopy.onclick = function () {
                ...
                toastNotification('Success! The Cookies was copied to your clipboard');
            };
            ...
            btnDownload.onclick = function () {
                ...
                a.click();
                toastNotification('Success! The Cookies File was downloaded ' + a.download);
                a.remove();
            };
        });
    }
